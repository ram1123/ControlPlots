...
fileIn = open("cutoffscale_FT.dat","read")


count = len(open("cutoffscale_FT.dat").readlines(  ))
print count
...
if pre:
	c1.SaveAs("cut-off_FT0_CMSpre.png")
	c1.SaveAs("cut-off_FT0_CMSpre.pdf")
else:
