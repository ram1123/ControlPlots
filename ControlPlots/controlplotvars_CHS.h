...
// { "deltaR_lPuppiak8jet", 0, 7.0, 20, 1, "#Delta R(l,AK8 jet)", "deltaR_lPuppiak8jet", 0, 7.0, 20, 1},
 ...
 { "mass_lvj_type0_PuppiAK8", 	450, 2500, 50, 3, "M_{WW} (GeV)",		"mass_lvj_type0_PuppiAK8",    450, 2500, 50, 1},
 ...
 { "mass_lvj_type0_PuppiAK8", 	450, 2500, 5, 3, "M_{WW} (GeV)",		"mass_lvj_type0_PuppiAK8_5bin",    450, 2500, 5, 1},
 ...
 { "l_pt1",		30, 390, 24, 3,		"Lepton p_{T} (GeV)",     "lepton_pt",       30,  390, 24, 1 },
 { "l_eta1",		-2.5, 2.5, 8, 1,	"Lepton #eta",            "lepton_eta",    -2.5,  2.5,  8, 0 },
...
//////	MET
// { "pfMET_Corr",	0.0, 500, 50, 3,	"pf MET (GeV)",		"pfMET_Corr",	 0.0, 500, 50, 1 },
...
//// { "PuppiAK8_jet_mass_pr", 	40, 150, 11, 3, "AK8 pruned mass (GeV)",	"AK8_mass_pr", 40.0, 150, 11, 1},
 { "PuppiAK8_jet_mass_so", 	40, 150, 22, 3, "AK8 Softdrop mass (GeV)",	"AK8_mass_so", 40.0, 150, 22, 1},
 { "PuppiAK8_jet_mass_so", 	0, 65, 13, 3, "AK8 Softdrop mass (GeV)",	"AK8_mass_so_LSB", 0, 65, 13, 1},
 { "PuppiAK8_jet_mass_so", 	40, 150, 11, 3, "AK8 Softdrop mass (GeV)",	"AK8_mass_so_11bin", 40.0, 150, 11, 1},
...
//// { "PuppiAK8_jet_mass_so", 	65, 105, 5, 3, "AK8 Softdrop mass (GeV)",	"AK8_mass_so", 65, 105, 5, 1},
...
// { "vbf_maxpt_j1_pt", 30, 630, 24, 3,		"Leading VBF Jet p_{T}",	"vbf_maxpt_j1_pt", 30,630,24,1 },
 ...
 { "BosonCentrality_type0",	1, 4.0, 8, 1, 	"Boson Centrality",	"BosonCentrality_type0",1, 4.0, 8, 1 },
...
// Angular variables
 ...
 { "ZeppenfeldWL_type0/vbf_maxpt_jj_Deta", 	-0.5, 0.5, 20, 1, "ZeppenfeldWL/#Delta #eta jj"  , "ZeppenfeldWL_type0_new" , -0.5, 0.5, 20, 1}, 
 { "ZeppenfeldWH/vbf_maxpt_jj_Deta", 	-0.5, 0.5, 20, 1, 		"ZeppenfeldWH/#Delta #eta jj"  , "ZeppenfeldWH_new" , -0.5, 0.5, 20, 1}, 
