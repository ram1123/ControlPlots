...
//
//    LEPTONS
 { "mass_llj_PuppiAK8", 	400, 1200, 16, 1, 	"M_{ww}"  , "mass_llj_PuppiAK8" , 400, 1200, 16, 0}, 
...
// { "l_pt1+l_pt2+ungroomed_PuppiAK8_jet_pt+vbf_maxpt_j1_pt+vbf_maxpt_j2_pt",	0, 1500, 15, 3, "HT", "ht", 0, 1500, 15, 1},
//
